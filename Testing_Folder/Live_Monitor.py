...
colors = {"background": "black", "text": "#7FDBFF"}
app.layout = html.Div(
    className="app-body",
...
@app.callback(Output("clientside-data", "data"), Input("interval", "n_intervals"))
def update_graph_scatter(n):
    ...
    plot_data = {
        ...
        "Vrms": list(V_rms),
        "Irms": list(I_rms),
        "Real_Power": list(Real_Power),
        "PF": list(PF),
        "VA": list(VA),
        "Raw": last_entry["RAW_Packet"],
    }
    return plot_data
